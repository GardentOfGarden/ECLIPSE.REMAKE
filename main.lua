-- [< - Rewrite Made By BypassDev - >]
repeat
    task.wait()
 until game:IsLoaded()

-- Menu/UI Creation
if not isfile("Optix.Wtf") then
    makefolder("Optix.Wtf")
 end
 
 local menu = game:GetObjects("rbxassetid://89960428223118")[1] 
 local tabholder = menu.bg.bg.bg.bg.bg.bg.main.group;
 local tabviewer = menu.bg.bg.bg.bg.bg.bg.tabbuttons;
 local TopGradient = menu.bg.TopLine.UIGradient
 local hue = 0
 game:GetService("RunService").RenderStepped:Connect(function(dt)
     ...
     local colors = {}
     for i = 0, 1, 0.25 do
         local thisHue = (hue + i) % 1
         table.insert(colors, ColorSequenceKeypoint.new(i, Color3.fromHSV(thisHue, 1, 1)))
     end
     TopGradient.Color = ColorSequence.new(colors)
 end)
 --
 ...
 local library = {
    ...
    Watermark = createWatermark(),
       Colors = {
          libColor = Color3.fromRGB(43, 0, 255),
          riskyColor = Color3.fromRGB(255, 0, 0),
          FontColor = Color3.fromRGB(255, 255, 255),
          MainColor = Color3.fromRGB(14, 14, 14),
          AccentColor = Color3.fromRGB(43, 0, 255),
    ...
    CloneScreenGui.Name = "Optix.Wtf_gui"
    ...
    local function animateTextLabel(TextLabel)
        ...
        while true do
            ...
            while TextLabel.TextTransparency > 0 do
                TextLabel.TextColor3 = getRainbowColor(hue)
                hue = (hue + 1) % 360
                wait(0.05)
            end
        ...
        pcall(Line.TweenSize, Line, UDim2.new(0, 0, 0, 2), 'Out', 'Linear', Time or 5, true)
            ...
            draggable(menu.bg)
                ...
                function library:Tween(...) TweenService:Create(...):Play() end
                    function library:addTab(name,image)
                        ...
                        for _, v in pairs(list) do
                            ...
                            writefile("Optix.Wtf/"..name..".cfg",game:GetService("HttpService"):JSONEncode(jig))
                ...
                function library:refreshConfigs()
                    local tbl = {}
                    for i,v in next, listfiles("Optix.Wtf") do table.insert(tbl,v) end
